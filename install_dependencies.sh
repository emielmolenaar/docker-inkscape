...
#
# Original source: https://gitlab.com/inkscape/inkscape-ci-docker/-/raw/master/install_dependencies.sh
# Modified for this docker image to disable the installation adwaita-icon-theme-full
#
...
if [[ "$ID" == "debian" || "$ID" == "ubuntu" \
    ...
    if $RECOMMENDED_DEPENDENCIES; then
	    ...
	    cython \
            ...
            python3-lxml \
            python3-serial \
            python3-scour  || echo "Installation of optional (recommended) dependencies failed. Building will still work. Some extensions may not run."
